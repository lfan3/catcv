...
def encrypt_aes(inputpath, outputpath):
    ...
    key = PBKDF2(PASS, salt, dkLen=32, count=1000000, hmac_hash_module=SHA256)
...
def dycrpt_aes(inputpath, outputpath):
    with open(inputpath, 'rb') as file:
...
# encrypt_aes('./catcv.pdf','./catcv_aes.pdf')
# dycrpt_aes('./catcv_aes.pdf','./catcv_de.pdf')
